    ...
    <div>
      ...
      <div className="text-gray-100">
        ...
        <p className="text-gray-100">
          ...
          text-channels will appear for the roles you have assigned yourself. We also have channels
          for non-gaming topics, like general, tech, memes, anime and many more.
        </p>
        <p className="text-gray-100">
          Dynamic voice channels are now available, where you can hang out with your friends. When
          you join a voice channel a new one will be created there will always be one empty however
          feel free to connect to one and chat with us.
        </p>
